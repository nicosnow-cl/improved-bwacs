class FreeAntEMVRP_1:
    def __init__(self, depot, nodes, start, combinations_matrix, distances_matrix, demands_array,
                 vehicle_capacity, tare, alpha, beta, q0):
        import numpy as np
        import random
    ...
    def run(self):
        ...
        while unvisited_nodes.size:
            ...
            valid_nodes = unvisited_nodes[unvisited_nodes_sorted][:int(len(self.nodes)/3)]
            ...
            while valid_nodes.size:
                ...
                valid_nodes = valid_unvisited_nodes[valid_unvisited_nodes_sorted][:int(len(self.nodes)/3)]
